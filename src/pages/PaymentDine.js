...
const PaymentDine = () => {
    ...
    const handlePayment = () => {
        ...
        // Pass order ID, amount, and dine-in method to PaymentPage
        navigate(`/payment?orderId=${orderId}&amount=${amount}&method=dine-in`);
    };

    return (
        <div className="payment-container">
            <h2>🍽 Dine-In Payment</h2>
            {orderId && amount ? (
                <>
